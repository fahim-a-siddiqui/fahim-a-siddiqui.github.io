# Informative
**Open-Source Repository for Informative**. Here you will find all of our programs, files, and open-source material. We are still currently developing so we hope to expand our codes, programs, and achievments later on. Also, as a note, we use the main branch for hosting our website. 
...
## Projects
We usually code in Python, C++, Javascript, and a few other developing prominent progamming languages. We use [Flutter](https://flutter.dev) to develop our apps, and [Visual Sudio Code](https://code.visualstudio.com/). Happy Coding! 
